...
const Contact = () => {
    useDocTitle('داناتليكوم | أرسل لنا رسالة')
    ...
    const sendEmail = (e) => {
        ...
        const whatsappMessage = `*رسالة جديدة من موقع داناتليكوم*\n\n` +
        ...
        const whatsappNumber = '+352681554664'; // Your WhatsApp number without the '+' or '00'
            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">أرسل لنا رسالة</h1>
                        </div>
                        ...
                        <div
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        <h2 className="text-2xl">عنوان المكتب</h2>
                                        <p className="text-gray-400">سوريا , ادلب , الدانا</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: +352 681 554 664</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">أرسل لنا ايميل</h2>
                                <p className="text-gray-400">dana.telecom@hotmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.facebook.com/danatelecom.sy/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
