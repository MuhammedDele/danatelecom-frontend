...
const NanoBeamForm = ({ onSubmit, onCancel, product }) => {
    // const navigate = useNavigate();
    const [formData, setFormData] = useState({
        title: '',
        description: '',
        price: '',
        type_detail: 'nanobeam',
        isActive: true
    });
    ...
    useEffect(() => {
        if (product) {
            setFormData({
                ...
                price: product.price || '',
                type_detail: product.type_detail || 'nanobeam',
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <select
                    ...
                    className="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500"
                >
                    <option value="nanobeam">نانوبيم</option>
                    <option value="nanostation">نانوستيشن</option>
                    <option value="powerbeam">باوربيم</option>
                    <option value="airmax">ايرماكس</option>
                </select>
            </div>
